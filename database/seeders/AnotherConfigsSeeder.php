...
class AnotherConfigsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert("INSERT INTO clients( name_client, idcard_client, address_client, id_state, taxpayer_client, porcentual_amount_tax_client) VALUES ('INVERSIONES LUDYS MODAS C.A', 'J402050054', 'AV ANDRES BELLO EDIF CECALA 56 PISO PB', 4, 1, 75),
('FELIZ INFANTIL', 'J400794226', 'AV FRANCISCO DE LORETO LOCAL NRO 47-1', 4, 1, 75),
('FELIZ BABY', 'J407445863', 'CALLE LONGORIA C.C VICTORIA CENTER PB LOCAL A-56', 4, 1, 75),
('RESTURANT LUNCHERIA LA PROVIDENCIA', 'J296261172', 'CALLE LIBERTADOR CRUCE CON RIVAS DAVILA LA VICTORIA EDO ARAGUA', 4, 1, 75),
('EXPRESS MANSION VICTORIA', 'J407968050', 'CALLE RIVAS DAVILA CC PLENO CENTRO NIVEL 1 LOCAL 5 Y 6', 4, 1, 75);");

        DB::insert("INSERT INTO clients( name_client, idcard_client, address_client, id_state) VALUES       
...
('INVERSIONES LUNA SOL', 'J405047968', 'CALLE INDEPENDENCIA NRO 104-23-10', 4);");
        ...
        DB::insert("INSERT INTO suppliers( name_supplier, idcard_supplier, address_supplier, id_state, taxpayer_supplier, porcentual_amount_tax_supplier) VALUES 
        ('INVERSIONES LUDYS MODAS C.A', 'J402050054', 'AV ANDRES BELLO EDIF CECALA 56 PISO PB', 4, 1, 75),
('FELIZ INFANTIL', 'J400794226', 'AV FRANCISCO DE LORETO LOCAL NRO 47-1', 4, 1, 75),
('FELIZ BABY', 'J407445863', 'CALLE LONGORIA C.C VICTORIA CENTER PB LOCAL A-56', 4, 1, 100)");
