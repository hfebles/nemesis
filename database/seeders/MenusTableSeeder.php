...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Contabilidad
        Menu::create(['id' => 43, 'name' => 'Retenciones de iva Compras', 'slug' => 'withholdingpurchases.index', 'grupo' => 'accounting-withholding-purchases', 'icono' => 'fa-sharp fa-solid fa-table-list', 'parent' => '39', 'order' => '3', 'href' => '0', ]);
    }
