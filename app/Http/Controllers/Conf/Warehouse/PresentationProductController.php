...
class PresentationProductController extends Controller
{
    ...
    public function store(Request $request){
       ...
       // return redirect()->route('presentation.index')->with('success', );

        $message = [
            'type' => 'success',
            'message' => 'La nueva presentación '.$save->name_presentation_product.' se registró con exito',
        ];           

        return redirect()->route('presentation.index')->with('message', $message);
    }
    ...
    public function update(Request $request, $id){
        ...
        $message = [
            'type' => 'warning',
            'message' => 'La presentación '.$data['name_presentation_product'].' se a editado con exito',
        ];           
