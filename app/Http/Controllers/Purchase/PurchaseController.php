...
class PurchaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = Purchase::select('id_purchase', 'date_purchase', 'ref_name_purchase', 'total_amount_purchase', 'os.name_order_state', 's.name_supplier')
            ...
            ->orderBy('purchase.id_order_state', 'ASC')
    ...
    public function store(Request $request){
        ...
        return redirect()->route('purchase.show', $saveSalesOrder->id_purchase)->with('message', $message);
    }
    ...
    public function show($id){
        ...
        return view('purchases.purchase.show', compact('conf', 'data', 'dataProducts', 'obj'));
    }
